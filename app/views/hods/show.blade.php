...
<div class="col-md-6">
    <ul class="nav nav-pills">
        <li><a href="{{ URL::route('subjects.create') }} ">Add Subjects</a></li>
        <li><a href="{{ URL::route('teachers.create') }} ">Add Teachers</a></li>
        <li><a href="{{ URL::route('semisters.create') }} ">Add Semister</a></li>
    </ul>
